...
PYTHON_CMD='python3'
LOG_FILE='/home/ubuntu/projects/alpha-pilot/logs/laya_text.log'
...
echo "===== $stamp START --laya-text =====" >> "$LOG_FILE"
timeout --kill-after=15s 600s $PYTHON_CMD main.py --laya-text >> "$LOG_FILE" 2>&1
exit_code=$?
stamp="$(date '+%Y-%m-%d %H:%M:%S')"

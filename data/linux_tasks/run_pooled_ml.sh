...
PYTHON_CMD='python3'
LOG_FILE='/home/ubuntu/projects/alpha-pilot/logs/pooled_ml.log'
...
echo "===== $stamp START --train-pooled-model =====" >> "$LOG_FILE"
timeout --kill-after=15s 900s $PYTHON_CMD main.py --train-pooled-model >> "$LOG_FILE" 2>&1
exit_code=$?
stamp="$(date '+%Y-%m-%d %H:%M:%S')"

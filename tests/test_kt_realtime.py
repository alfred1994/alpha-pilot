...
def test_normalize_security():
    ...
    market, code, symbol, sec_type = client.normalize_security("301363")
    assert_true((market, code, symbol, sec_type) == ("SZ", "301363", "sz301363", "stock"), "创业板301段代码")
    market, code, symbol, sec_type = client.normalize_security("302001")
    assert_true((market, code, symbol, sec_type) == ("SZ", "302001", "sz302001", "stock"), "创业板302段代码")

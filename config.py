...
# ══════════════════════════════════════════════════════════════════
SIGNAL_WEIGHTS = {
    "technical": 0.35,           # 技术面 35%（主要信号）
    "capital": 0.08,             # 资金面 8%（数据不稳定）
    "sentiment": 0.20,           # 舆情面 20%（LLM分析）
    "emotion": 0.12,             # 情绪面 12%（市场整体）
    "fundamental": 0.08,         # 基本面 8%（数据不稳定）
    "ml": 0.17,                  # ML预测 17%（LightGBM量化信号）
}
